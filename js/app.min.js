...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-project-template/./node_modules/swiper/shared/classes-to-selector.mjs?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ createShadow)\n/* harmony export */ });\n/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ \"./node_modules/swiper/shared/utils.mjs\");\n\n\nfunction createShadow(suffix, slideEl, side) {\n  const shadowClass = `swiper-slide-shadow${side ? `-${side}` : ''}${suffix ? ` swiper-slide-shadow-${suffix}` : ''}`;\n  const shadowContainer = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(slideEl);\n  let shadowEl = shadowContainer.querySelector(`.${shadowClass.split(' ').join('.')}`);\n  if (!shadowEl) {\n    shadowEl = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.c)('div', shadowClass.split(' '));\n    shadowContainer.append(shadowEl);\n  }\n  return shadowEl;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-project-template/./node_modules/swiper/shared/create-shadow.mjs?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   e: () => (/* binding */ effectTarget)\n/* harmony export */ });\n/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ \"./node_modules/swiper/shared/utils.mjs\");\n\n\nfunction effectTarget(effectParams, slideEl) {\n  const transformEl = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(slideEl);\n  if (transformEl !== slideEl) {\n    transformEl.style.backfaceVisibility = 'hidden';\n    transformEl.style['-webkit-backface-visibility'] = 'hidden';\n  }\n  return transformEl;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-project-template/./node_modules/swiper/shared/effect-target.mjs?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/index.esm.js\");\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n\r\n\r\nswiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Grid]);\r\n\r\n\r\n\r\nwindow.addEventListener('DOMContentLoaded', () => {\r\n   const burger = document.querySelector(\"#burger\");\r\n   const menu = document.querySelector(\"#menu-id\");\r\n\r\n   if (burger) {\r\n      burger.addEventListener('click', () => {\r\n         document.querySelector(\".header\").classList.toggle(\"open\");\r\n         document.body.classList.toggle(\"blocked\");\r\n      });\r\n   }\r\n\r\n   window.addEventListener('keydown', () => {\r\n      document.querySelector(\".header\").classList.remove(\"open\");\r\n      document.body.classList.remove(\"blocked\");\r\n   });\r\n\r\n   document.querySelector(\"#menu-id\").addEventListener('click', event => {\r\n      event._isClickWithInMenu = true;\r\n   });\r\n\r\n   document.querySelector(\"#burger\").addEventListener('click', event => {\r\n      event._isClickWithInMenu = true;\r\n   });\r\n   document.body.addEventListener('click', event => {\r\n      if (event._isClickWithInMenu) return;\r\n      document.querySelector(\".header\").classList.remove(\"open\");\r\n      document.body.classList.remove(\"blocked\");\r\n   });\r\n\r\n   const swiperCompanies = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.companies__list', {\r\n      loop: false,\r\n      speed: 2400,\r\n      // slidesPerView: 2,\r\n      grid: {\r\n         rows: 2,\r\n      },\r\n      spaceBetween: 20,\r\n      navigation: {\r\n         prevEl: \".companies__swiper-button-prev\",\r\n         nextEl: \".companies__swiper-button-next\",\r\n      },\r\n      breakpoints: {\r\n         0: {\r\n            slidesPerView: 2,\r\n            grid: {\r\n               rows: 2,\r\n            },\r\n         },\r\n         320: {\r\n            slidesPerView: 2,\r\n            grid: {\r\n               rows: 2,\r\n            },\r\n         },\r\n         575: {\r\n            slidesPerView: 3,\r\n            grid: {\r\n               rows: 2,\r\n            },\r\n         },\r\n      }\r\n   });\r\n\r\n   //SWIPER SLIDER GALLERY\r\n   const swiperGallery = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.gallery__swiper', {\r\n      loop: false,\r\n      speed: 2400,\r\n      slidesPerView: 2,\r\n      initialSlide: 1,\r\n      navigation: {\r\n         prevEl: \".gallery__swiper-button-prev \",\r\n         nextEl: \".gallery__swiper-button-next\",\r\n      },\r\n      breakpoints: {\r\n         0: {\r\n            slidesPerView: 2,\r\n         },\r\n         575: {\r\n            slidesPerView: 3,\r\n         },\r\n         768: {\r\n            slidesPerView: 4,\r\n         },\r\n      }\r\n   });\r\n\r\n\r\n   //SWIPER SLIDER FEEDBACK\r\n   const swiperFeedback = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.feedback__swiper', {\r\n      loop: false,\r\n      speed: 2400,\r\n      slidesPerView: 1,\r\n      spaceBetween: 20,\r\n      autoHeight: true,\r\n      navigation: {\r\n         prevEl: \".feedback__swiper-button-prev \",\r\n         nextEl: \".feedback__swiper-button-next\",\r\n      },\r\n      breakpoints: {\r\n         0: {\r\n            slidesPerView: 1,\r\n         },\r\n         575: {\r\n            slidesPerView: 2,\r\n         },\r\n         992: {\r\n            slidesPerView: 3,\r\n         },\r\n      }\r\n   });\r\n   //SWIPER SLIDER UNOCORN\r\n   const swiperUnicorn = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.unicorn__swiper', {\r\n      loop: false,\r\n      speed: 2400,\r\n      slidesPerView: 1,\r\n      spaceBetween: 20,\r\n      navigation: {\r\n         prevEl: \".unicorn__swiper-button-prev \",\r\n         nextEl: \".unicorn__swiper-button-next\",\r\n      },\r\n      breakpoints: {\r\n         0: {\r\n            slidesPerView: 1,\r\n         },\r\n         575: {\r\n            slidesPerView: 2,\r\n         },\r\n      }\r\n   });\r\n\r\n   // Automatic recalculation of the images height\r\n   let plusItems = document.querySelectorAll('.program__plus-item');\r\n   let programImages = document.querySelectorAll('.program__item-img');\r\n   let hpImages = document.querySelector('.hp__img');\r\n\r\n   function changeImageSize(el, percent) {\r\n      let hplusItems = el.offsetWidth * percent;\r\n      el.style.height = hplusItems + 'px';\r\n   }\r\n\r\n   window.addEventListener('resize', () => {\r\n      plusItems.forEach(element => {\r\n         changeImageSize(element, 0.73);\r\n      });\r\n      programImages.forEach(element2 => {\r\n         changeImageSize(element2, 0.67);\r\n         // let hplusItems = element2.offsetWidth * 0.67;\r\n         // element2.style.height = hplusItems + 'px';   \r\n      });\r\n      if (hpImages) {\r\n         changeImageSize(hpImages, 0.8);\r\n      }\r\n   });\r\n\r\n   window.addEventListener('load', () => {\r\n      plusItems.forEach(element => {\r\n         changeImageSize(element, 0.73);\r\n      });\r\n      programImages.forEach(element2 => {\r\n         changeImageSize(element2, 0.67);\r\n         // let hplusItems = element2.offsetWidth * 0.67;\r\n         // element2.style.height = hplusItems + 'px';   \r\n      });\r\n      if (hpImages) {\r\n         changeImageSize(hpImages, 0.8);\r\n      }\r\n   });\r\n\r\n\r\n   //Smooth scroll\r\n   document.querySelectorAll('a[href^=\"#\"]').forEach(anchor => {\r\n      anchor.addEventListener('click', function (e) {\r\n         e.preventDefault();\r\n         document.querySelector(this.getAttribute('href')).scrollIntoView({\r\n            behavior: 'smooth'\r\n         });\r\n      });\r\n   });\r\n\r\n   //Package selection\r\n   let packageItems = document.querySelectorAll('.booking__packages-item');\r\n   let packagesList = document.querySelector('.booking__packages-items');\r\n\r\n   if (packageItems != null) {\r\n      packageItems.forEach(item => {\r\n         item.addEventListener('click', (e) => {\r\n            let tmpPackageItems = document.querySelectorAll('.booking__packages-item');\r\n            tmpPackageItems.forEach(tmp => {\r\n               if (tmp.classList.contains(\"booking__packages-item--active\")) {\r\n                  tmp.classList.remove(\"booking__packages-item--active\");\r\n               }\r\n            });\r\n            item.classList.add(\"booking__packages-item--active\");\r\n            e.stopPropagation();\r\n         });\r\n      })\r\n   }\r\n\r\n   //Fancybox\r\n   if (document.querySelector(\"[data-fancybox]\") != null) {\r\n      _fancyapps_ui__WEBPACK_IMPORTED_MODULE_3__.Fancybox.bind(\"[data-fancybox]\", {\r\n         // Options\r\n      });\r\n   }\r\n\r\n   //Accordeon\r\n   let accordeonTitles = document.querySelectorAll('.faq__item-title');\r\n\r\n   if (accordeonTitles.length != null) {\r\n      accordeonTitles.forEach(item => {\r\n         item.addEventListener('click', () => {\r\n            item.parentNode.classList.toggle('faq__item--active');\r\n         });\r\n      });\r\n   }\r\n\r\n   //Modals\r\n   const modals = document.querySelectorAll('.dialog');\r\n   const openModals = document.querySelectorAll('.open-modal');\r\n   const closeModals = document.querySelectorAll('.close-modal');\r\n\r\n   function openModalAndBlockScroll(modal) {\r\n      modal.showModal();\r\n      document.body.classList.add('scroll-block');\r\n   }\r\n\r\n   function returnScroll() {\r\n      document.body.classList.remove('scroll-block');\r\n   }\r\n\r\n   function close(modal) {\r\n      modal.close();\r\n      returnScroll();\r\n   }\r\n\r\n   function closeOnOverlayClick({ currentTarget, target }) {\r\n      const modal = currentTarget;\r\n      const isOnOverlayClick = (target === modal);\r\n      if (isOnOverlayClick) {\r\n         close(modal);\r\n      }\r\n   }\r\n\r\n   if (openModals.length > 0) {\r\n      openModals.forEach(openModal => {\r\n         openModal.addEventListener('click', (e) => {\r\n            let openModalId = openModal.getAttribute('data-modal');\r\n            let currentModal = document.getElementById(openModalId);\r\n\r\n            if (openModal.classList.contains('prices__item-button')) {\r\n               let priceItem = openModal.closest('.prices__item');\r\n               let priceTitle = priceItem.getElementsByClassName('prices__item-title')[0].innerHTML;\r\n               currentModal.getElementsByClassName('dialog__subtitle-packagename')[0].innerHTML = priceTitle;\r\n            }\r\n            openModalAndBlockScroll(currentModal);\r\n         });\r\n      });\r\n   }\r\n\r\n   if (closeModals.length > 0) {\r\n      closeModals.forEach(closeModal => {\r\n         closeModal.addEventListener('click', () => {\r\n            let closeModalParrent = closeModal.closest('.dialog');\r\n            close(closeModalParrent);\r\n         });\r\n      });\r\n   }\r\n\r\n   if (modals.length > 0) {\r\n      modals.forEach(modal => {\r\n         modal.addEventListener('click', closeOnOverlayClick);\r\n         modal.addEventListener('cancel', () => {\r\n            returnScroll();\r\n         });\r\n         modal.addEventListener('close', () => {\r\n            returnScroll();\r\n         });\r\n      });\r\n   }\r\n});\r\n\n\n//# sourceURL=webpack://gulp-project-template/./src/js/app.js?");
